...
struct led_led1_3_group_ctrl {
	unsigned char	led1md:2	; 
	unsigned char	led2md:2	; 
	unsigned char	led3md:2	; 
	unsigned char	dmy2:2		; 
};


struct led_group1_ctrl {
	unsigned char	grp1en:1	; 
	unsigned char	grp2en:1	; 
	unsigned char	flleden:1	; 
	unsigned char	dmy1:4		; 
	unsigned char	flmd:1		; 
};
...
extern int bd6082gul_reg_write(unsigned char sub2,
								unsigned char inf1);
extern int bd6082gul_dec_led1_3_setting(struct led_led1_3_group_ctrl *request );
