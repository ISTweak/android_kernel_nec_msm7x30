		...
		for (c = dev->nChunksPerBlock - 1;
			...
			if (!tags.chunkUsed) {
				...
				if (!in) {
					...
					T(YAFFS_TRACE_ERROR,
					  (TSTR
					   ("yaffs tragedy: found invalid value. ignore. "
					    "line:%u chunk:0x%X objectId:0x%X chunkId:0x%X"
					    TENDSTR), __LINE__, chunk , tags.objectId, tags.chunkId));
					yaffs_DeleteChunk(dev, chunk, 1, __LINE__);
					continue;
					...
					if (!in)
						...
						
						{
							T(YAFFS_TRACE_ERROR,
							  (TSTR
							   ("yaffs tragedy: found invalid value. ignore. "
							    "line:%u chunk:0x%X objectId:0x%X ObjectType:0x%X"
							    TENDSTR), __LINE__, chunk , tags.objectId, tags.extraObjectType));
							yaffs_DeleteChunk(dev, chunk, 1, __LINE__);
							continue;
						}
					...
					if (!parent)
						...
						
						{
							T(YAFFS_TRACE_ERROR,
							  (TSTR
							   ("yaffs tragedy: found invalid value. ignore. "
							    "line:%u chunk:0x%X objectId:0x%X parentObjectId:0x%X"
							    TENDSTR), __LINE__, chunk , tags.objectId, tags.extraParentObjectId));
							yaffs_DeleteChunk(dev, chunk, 1, __LINE__);
							continue;
						}
