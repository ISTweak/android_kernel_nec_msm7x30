...
void mdp4_mixer_blend_setup(struct mdp4_overlay_pipe *pipe)
{
	...
	if (bg_pipe->alpha_enable && pipe->alpha_enable && mdp4_overlay_argb_enable != MSM_FB_REQUEST_DISABLE) {
	...
	} else if (bg_pipe->alpha_enable && pipe->alpha_enable == 0 && mdp4_overlay_argb_enable != MSM_FB_REQUEST_DISABLE) {
