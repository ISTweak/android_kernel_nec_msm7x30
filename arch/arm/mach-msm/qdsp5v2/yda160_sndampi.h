...
#define SNDAMP_REG_0_POWER_DOWN1_VE221               0x01
...
#define SNDAMP_REG_7_VE137_MNX                   0x1F
                    
#define SNDAMP_REG_7_VE137_ZCS_MV                0x80
...
#define SNDAMP_GPIO_AUD_AMP_RST                     82  
#define SNDAMP_PMIC_GPIO_AUD_DDC_EN                 23  

#define SNDAMP_GPIO_HIGH_VALUE                      1   
#define SNDAMP_GPIO_LOW_VALUE                       0   
...
#define SNDAMP_REG_7_VE137_INIT_VAL              0x00
...
#define SNDAMP_SET_REG_0_POWER_DOWN1_VE221(data) \
  MM_DBG("SET REG0 POWERDOWN1 VE221[0x%x]\n", data); \
  SNDAMP_SET_REG_BUF( SNDAMP_REG_0_POWERDOWN1, data, SNDAMP_REG_BIT_D0, SNDAMP_REG_0_POWER_DOWN1_VE221 )
...
#define SNDAMP_SET_REG_7_VE137_MNX(data) \
  MM_DBG("SET REG7 VE137 MNX[0x%x]\n", data); \
  SNDAMP_SET_REG_BUF( SNDAMP_REG_7_VE137, data, SNDAMP_REG_BIT_D0, SNDAMP_REG_7_VE137_MNX )


#define SNDAMP_SET_REG_7_VE137_ZCS_MV(data) \
  MM_DBG("SET REG7 VE137 ZCS_MV[0x%x]\n", data); \
  SNDAMP_SET_REG_BUF( SNDAMP_REG_7_VE137, data, SNDAMP_REG_BIT_D7, SNDAMP_REG_7_VE137_ZCS_MV )
